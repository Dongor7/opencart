...
class PA_Widget_Custom_Menu extends PA_Widgets {
	...
	public function render( $settings = array(), $content = '' ) {
		$this->load->model( 'localisation/language' );
   		...
   		$settings['language_code'] = $settings[$language['code']];
		...
		return $this->load->view( 'extension/module/pavobuilder/pa_custom_menu/pa_custom_menu', array( 'settings' => $settings, 'content' => $content ) );
	}
}