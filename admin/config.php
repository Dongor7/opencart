<?php
// HTTP
define('HTTP_SERVER', 'http://www.opencart/admin/');
define('HTTP_CATALOG', 'http://www.opencart/');

// HTTPS
define('HTTPS_SERVER', 'http://www.opencart/admin/');
define('HTTPS_CATALOG', 'http://www.opencart/');
